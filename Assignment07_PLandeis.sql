...
-- 2022-02-24,PLandeis,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_PLandeis')
	 Begin 
	  Alter Database [Assignment07DB_PLandeis] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_PLandeis;
	 End
	Create Database Assignment07DB_PLandeis;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_PLandeis;
...
AS
  SELECT TOP 100 PERCENT
	...
	InventoryDate,
	InventoryCount,
	ISNULL(LAG(InventoryCount)OVER (ORDER BY ProductName, YEAR(InventoryDate)),0) AS PreviousMonthCount
